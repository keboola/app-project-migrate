...
class Migrate
{
    ...
    private bool $migrateDataDirectly;
    ...
    public function __construct(
        ...
        $this->migrateDataDirectly = $migrateDataDirectly;
        $this->logger = $logger;
    }
    ...
    private function backupSourceProject(string $backupId): void
    {
        ...
        $job = $this->sourceJobRunner->runJob(
            ...
            [
                'parameters' => [
                    'backupId' => $backupId,
                    'exportStructureOnly' => $this->migrateDataDirectly,
                ],
            ]
        );
